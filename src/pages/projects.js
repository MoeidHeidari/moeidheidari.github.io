...
const PresentationPage = () => (
  <Layout>
    ...
    <h1>Open source projects</h1>
      ...
      <ProjectItem  longDescription={'Non homogeneous Heat conduction equation implementation in C++.'} address={'https://github.com/MoeidHeidari/PDE'} year={'2021'} description={'Nonhomogeneous PDE - Heat Equation resolver'} title={''}/>
